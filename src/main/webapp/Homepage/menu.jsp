        ...
        <div class="navbar yellow navbar-default red2 yamm">
          ...
          <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
            <ul class="nav red2 navbar-nav">
              ...
              <li> <a href="menu.html" class="dropdown-toggle active">Menu</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
          <div class="feature-box34 bmargin">
            <div class="image-holder"><img src="images/menu1.jpg" alt="" class="img-responsive fit-image2" /></div>
        ...
        <div class="col-md-6 col-sm-12">
          <div class="feature-box34 bmargin">
            <div class="image-holder"><img src="images/h1.jpg" alt="" class="img-responsive fit-image2" /></div>
            <div class="text-box-right more-padding-3 text-center">
        ...
        <div class="col-md-6 col-sm-12">
          <div class="feature-box34 bmargin">
            <div class="image-holder"><img src="images/h5.jpg" alt="" class="img-responsive fit-image2" /></div>
            <div class="text-box-right more-padding-3 text-center">
        ...
        <div class="col-md-6 col-sm-12">
          <div class="feature-box34 bmargin">
            <div class="image-holder"><img src="images/menu3.jpg" alt="" class="img-responsive fit-image2" /></div>
            <div class="text-box-right more-padding-3 text-center">
