    ...
    <section>
      <div class="header-inner two">
        <div class="inner text-center">
          <h4 class="title text-white uppercase old-standardtt">Contact Us</h4>
    ...
    <section>
      <div class="pagenation-holder">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <h3 class="old-standardtt">Contact Us</h3>
            </div>
            <div class="col-md-6 text-right">
              <div class="pagenation_links"><a href="home">Home</a> <i>/</i> Contact Us</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <div class="smart-forms bmargin">
              ...
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo
                augue. Aliquam ornare hendrerit consectetuer adipiscing elit. Suspendisse et justo. augue.</p>
              <br />
              <br />
              <form method="post" action="php/smartprocess.php" id="smart-form">
                ...
                <div class="form-footer">
                  <button type="submit" data-btntext-sending="Sending..."
                    class="button btn-primary red-2">Submit</button>
          ...
          <div class="col-md-4 bmargin">
            <h3 class="old-standardtt">Address Info</h3>
            ...
            <div class="clearfix"></div>
            <br />
            <h3 class="old-standardtt">Find the Address</h3>
