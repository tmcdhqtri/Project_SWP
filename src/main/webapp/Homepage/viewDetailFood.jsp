    ...
    <div class="site_wrapper">
        ...
        <div class="row">
            ...
            <div class="row col-md-6">
              ...
              <form action="addCart" class="row col-md-12" method="">
                    ...
                    <div class="col-md-3 minusplus">
                        ...
                        <input name="sl" id="numberPlace" type="hidden" value=""/>
        ...
        <section class="section-copyrights sec-moreless-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12"> <span>Copyright 2022 by King's Fast Food | All rights reserved.</span>
                    </div>
                </div>
            </div>
        </section>
