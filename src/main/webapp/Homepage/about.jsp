    ...
    <div class="navbar yellow navbar-default red2 yamm">
      ...
      <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
        <ul class="nav red2 navbar-nav">
          ...
          <li> <a href="about" class="dropdown-toggle active">About</a></li>
  ...
  <section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase old-standardtt">About Us</h4>
        <h5 class="text-white uppercase">Get many More Features</h5>
      </div>
      <div class="overlay bg-opacity-5"></div>
      <img src="./Homepage/images/h4.jpg" alt="" class="img-responsive fit-image"/> </div>
  </section>
  <!-- end header inner -->
  <div class="clearfix"></div>
  ...
  <section>
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3 class="old-standardtt">About Us</h3>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <h1 class="section-title-4 great-vibes text-center">About Us</h1>
          <p class="sub-title text-center">Lorem ipsum dolor sit amet consectetuer adipiscing.</p>
        </div>
        <div class="clearfix"></div>
        <div class="col-md-6 bmargin"> <img src="./Homepage/images/h3.jpg" alt="" class="img-responsive"/> </div>
        <!--end item-->
        
        <div class="col-md-6 bmargin">
          <h2 class="old-standardtt">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</h2>
        ...
        <div class="col-md-6 bmargin"> <img src="./Homepage/images/h1.jpg" alt="" class="img-responsive"/> </div>
        <!--end item--> 
      </div>
    </div>
  </section>
      ...
      <div class="container sec-tpadding-3 sec-bpadding-3">
        <div class="row">
          <div class="col-md-8 col-centered">
            ...
            <p class="text-white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Curabitur eget orci. Cras laoreet <br/>
              consectetuer  ligula. Etiam sit amet dolor. </p>
            <br/>
            <br/>
            <a class="btn btn-white round" href="#">Reserve</a> </div>
        </div>
      </div>
    </div>
  </section>
