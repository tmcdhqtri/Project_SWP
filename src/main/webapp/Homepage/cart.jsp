                ...
                <div class="navbar yellow navbar-default red2 yamm">
                    ...
                    <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
                        <ul class="nav red2 navbar-nav">
                            ...
                            <li> <a href="viewOrderHisStaff.html" class="dropdown-toggle">Special</a></li>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="images/food/Food13.png" alt="" class="img-responsive fit-image4" /></td>
                    <td class="text-center">Spaghetti</td>
                    <td class="text-center">$ 17.00</td>
                    <td class="text-center">
                        <div class=" minusplus">
                ...
                <tr>
                    <td><img src="images/menu2.jpg" alt="" class="img-responsive fit-image4" /></td>
                    <td class="text-center">Spaghetti</td>
                    <td class="text-center">$ 17.00</td>
                    <td class="text-center">
                        <div class=" minusplus">
