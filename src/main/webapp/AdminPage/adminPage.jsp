...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/vendors/css/extensions/toastr.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/css/pages/dashboard-ecommerce.css">
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/css/plugins/charts/chart-apex.css">
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/css/plugins/extensions/ext-component-toastr.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script src="./AdminPage/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="./AdminPage/app-assets/vendors/js/extensions/toastr.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="./AdminPage/app-assets/js/scripts/pages/dashboard-ecommerce.js"></script>
    <!-- END: Page JS-->
