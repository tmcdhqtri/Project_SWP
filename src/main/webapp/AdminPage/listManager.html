    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a class="d-flex align-items-center" href="listManager.html"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">List Manager</span></a>
                </li>
            ...
            <div class="content-body">
                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="./app-assets/images/portrait/small/avatar-s-9.jpg" class="mr-75" height="50" width="50" alt="Peter" />
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="updateManager.html">
                        ...
                        <a href="addManager.html" class="btn btn-primary mt-2 mr-1">Add Manager</a>
                    </div>
                </div>
                <!-- users list ends -->
            </div>
