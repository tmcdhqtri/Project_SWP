            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Add Manager</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="listManager.html">List Manager</a>
                                    </li>
                                    <li class="breadcrumb-item active"> Add Manager
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <form class="validate-form mt-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <a href="listManager.html" class="btn btn-outline-secondary mt-2">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--/ form -->
