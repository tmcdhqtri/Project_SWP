...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/vendors/css/tables/datatable/responsive.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/vendors/css/tables/datatable/buttons.bootstrap4.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="./AdminPage/app-assets/css/pages/app-user.css">
    <!-- END: Page CSS-->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="${s.getPersonnelImageUrl()}" class="mr-75" height="50" width="50" alt="Peter" />
                                                <span class="font-weight-bold">${s.getPersonnelName()}</span>
                                            </td>
                                            <td>
                                                <span class="font-weight-bold">${s.getPersonnelEmail()}</span>
                                            </td>
                                            <td><span class="font-weight-bold">${s.getPersonnelPhone()}</span></td>
                                            <c:if test="${s.isPersonnelStatus()==true}">
                                            <td><div class="badge badge-glow badge-success" style="padding: 4px 12px;">active</div></td>
                                            </c:if>
                                            <c:if test="${s.isPersonnelStatus()==false}">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="deleteStaff?personnelID=${s.getPersonnelID()}">
...
<!--                                        <tr>
                        ...
                        <a href="addStaff" class="btn btn-primary mt-2 mr-1">Add Staff</a>
                    </div>
                </div>
                <!-- users list ends -->
            </div>
    ...
    <script src="./AdminPage/app-assets/vendors/js/tables/datatable/responsive.bootstrap4.js"></script>
    <script src="./AdminPage/app-assets/vendors/js/tables/datatable/datatables.buttons.min.js"></script>
    <script src="./AdminPage/app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="./AdminPage/app-assets/js/scripts/pages/app-user-list.js"></script>
    <!-- END: Page JS-->
