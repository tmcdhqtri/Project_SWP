            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    ...
                    <section id="page-account-settings">
                        <form action ="UpdateOrderAdminServlet" method ="post" class="mt-2">
                        <div class="row">
                                                ...
                                                <div class="card-body">
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item">Pay: 
                                                            ...
                                                            <li class="list-group-item">Status: <span class="font-weight-bold"> Success</span></li>
                                                            </c:if>
                                                            <c:if test="${o.getOrderStatus()==2}">
                                                            <li class="list-group-item">Status: <span class="font-weight-bold"> Canceled</span></li>
                                                            </c:if>
                                                    </ul>
                                                </div>
                                            </div>
                                                                    ...
                                                                    <c:if test="${d.getOrderID()==o.getOrderID()}">
                                                                        ...
                                                                        <c:forEach items="${FOODLIST}" var = "f">
                                                                            <c:if test="${f.getFoodID() == d.getFoodID()}">
                                                                                ...
                                                                                <td>
                                                                                    <span class="font-weight-bold" style="padding-left: 25px;">${d.getQuantity()}</span>
                                                                                </td>
                                                                                <td>
                                                                                    <span class="font-weight-bold" style="padding-left: 10px;">${Math.floor(d.getQuantity() * f.getFoodPrice())}</span>
                                                                                </td>
