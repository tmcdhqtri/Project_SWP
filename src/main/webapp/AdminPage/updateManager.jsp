            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Manager Details</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="listManager.html">List Manager</a>
                                    </li>
                                    <li class="breadcrumb-item active"> Manager Details
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    <img src="./app-assets/images/portrait/small/avatar-s-9.jpg" id="account-upload-img" class="rounded mr-50" alt="profile image" height="100" width="100" />
                                                </a>
