...
<html class="loading dark-layout" lang="en" data-layout="dark-layout" data-textdirection="ltr">
    ...
    <head>
        ...
        <link rel="apple-touch-icon" href="./AdminPage/AdminPage/app-assets/images/ico/apple-icon-120.png">
        ...
        <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-dark navbar-shadow container-xxl">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="${sessionScope.acc.personnelImageUrl}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="account-name" name="FOODNAME" placeholder="Food Name" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="number" class="form-control" placeholder="Price" name="PRICE" aria-label="Amount (to the nearest dollar)" />
                                                    ...
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <div class="form-label-group mb-0">
                                                            <textarea data-length="200" class="form-control char-textarea" id="textarea-counter" rows="4" name="DESCRIPTION" placeholder="Description"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <a href="listFood" class="btn btn-outline-secondary mt-2">Cancel</a>
                                                    </div>
                                                </div>
                                                </form>
                                                <!--/ form -->
